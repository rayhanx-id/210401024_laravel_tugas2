...
<div id="content" class="m-4 m-md-5 mt-5">
	...
	<div class="d-grid gap-2">
		...
		<a style="background-color: #F1C376" href="{{ route('categories.create') }}" class="btn btn-save" type="submit" ><i class="fa fa-cloud-upload" aria-hidden="true"></i> <label>Buat Kategori</label></a>
	</div>
